...
# NAME:   __info
# ALIAS:  info
# DESC:   Display information messages.
# USAGE:  info [<message>]
#==---------------------------------------------------------------------------------
info() {
  printf '%s\n' "${BOLD}${GREY}>${NO_COLOR} $*"
...
# NAME:   __completed
# ALIAS:  completed
# DESC:   Display completion messages.
...
# NAME:   __clearx
# ALIAS:  clearx
# DESC:   Clear the terminal screen based on OS.
# USAGE:  clearx
#==---------------------------------------------------------------------------------
clearx() {
...
# NAME:   __print_header
# ALIAS:  print_header
# DESC:   Print the header with the kit logo.
# USAGE:  print_header [<color>]
#==---------------------------------------------------------------------------------
print_header() {
...
# DESC:   Install a package using the appropriate package manager.
...
# NAME:   __check_deps
# ALIAS:  check_deps
# DESC:   Check if the required dependencies are installed.
# USAGE:  check_deps <dependency1> [<dependency2> ...]
#==---------------------------------------------------------------------------------
check_deps() {
  print_header
...
# NAME:   __compare
# ALIAS:  compare
# DESC:   Compare two version numbers.
# USAGE:  compare <version1> <version2>
#==---------------------------------------------------------------------------------
compare() {
...
# NAME:   __check_update
# ALIAS:  check_update
# DESC:   Check if an update is available.
# USAGE:  check_update
#==---------------------------------------------------------------------------------
check_update() {
